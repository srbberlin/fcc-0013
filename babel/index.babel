  ...
  render() {
    ...
    return (
      <div id="Edit" style={{display:v}}>
        <textarea className="subcontainer" onChange={this.titleNew} value={this.state.title}></textarea>
        <textarea className="subcontainer" onChange={this.ingredientsNew} value={this.state.ingredients}></textarea>
        <textarea className="subcontainer" onChange={this.procedureNew} value={this.state.procedure}></textarea>
        <textarea className="subcontainer" onChange={this.categoryNew} value={this.state.category}></textarea>
